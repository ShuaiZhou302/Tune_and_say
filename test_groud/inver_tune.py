...
def tune_and_output():
    ...
    """
    # Load audio
    sample_rate, data = wavfile.read(r"C:\Users\David Zhou\Desktop\bad apple (vocal).wav")
    ...
    fft_frame_size = 2048  # Increase frame size for better quality
    ...
    wavfile.write("badapplevocal_shifted.wav", sample_rate, output.astype(np.int16))
